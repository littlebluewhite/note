---
title: q3433. Count Mentions Per User / 統計每個使用者的提及次數
note_type: knowledge
domain: leetcode
...
status: active
source: leetcode
complexity_time: O(m log m + m * k + n * m)
complexity_space: O(n + m)
review_interval_days: 14
next_review: 2026-02-17
canonical: leetcode/q3433.md
---
# q3433. Count Mentions Per User / 統計每個使用者的提及次數
