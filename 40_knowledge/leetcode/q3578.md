---
title: q3578. Count Partitions With Max-Min Difference at Most K / 統計最大最小差值至多為 K 的分割
note_type: knowledge
domain: leetcode
...
canonical: leetcode/q3578.md
---
# q3578. Count Partitions With Max-Min Difference at Most K / 統計最大最小差值至多為 K 的分割
...
通用演算法筆記：[monotonic_queue](../algorithm/monotonic_queue.md)
...
## 補充筆記：O(n) 儲存 `dp`、`prefix` 與兩個隊列（隊列長度不超過目前視窗大小）。
