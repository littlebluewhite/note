---
title: q1895. Largest Magic Square / 最大的幻方
note_type: knowledge
domain: leetcode
...
status: active
source: leetcode
complexity_time: "O(mn + sum_{k=1..K}(m-k+1)(n-k+1)k)"
complexity_space: O(mn)
review_interval_days: 14
next_review: 2026-02-17
canonical: leetcode/q1895.md
---
# q1895. Largest Magic Square / 最大的幻方
...
- 時間：`O(mn + sum_{k=1..K}(m-k+1)(n-k+1)k)`
- 空間：`O(mn)`
...
`n`: number of columns.
`K`: min(m, n).
`k`: candidate square size in the summation (1..K).
